...
cp target/release/intent "$INSTALL_DIR/intent"
cp target/release/intent "$INSTALL_DIR/intentloop"
cp target/release/intent "$INSTALL_DIR/intern"

echo "=== Installation Completed ==="
echo "The binary has been installed to $INSTALL_DIR/ as:"
echo "  - intent"
echo "  - intentloop"
echo "  - intern"
echo ""
